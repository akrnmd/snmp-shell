...
class LinuxServerShell(object):
    ...
    def cpu_load(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.CPU Load'] if 'LinuxServerShell.CPU Load' in self.attributes else None

    @cpu_load.setter
    def cpu_load(self, value='0'):
        """
        
        :type value: str
        """
        self.attributes['LinuxServerShell.CPU Load'] = value
    ...
    def memory_load(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.Memory Load'] if 'LinuxServerShell.Memory Load' in self.attributes else None

    @memory_load.setter
    def memory_load(self, value='0'):
        """
        
        :type value: str
        """
        self.attributes['LinuxServerShell.Memory Load'] = value
    ...
    def hdd_load(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.HDD Load'] if 'LinuxServerShell.HDD Load' in self.attributes else None

    @hdd_load.setter
    def hdd_load(self, value='0'):
        """
        
        :type value: str
        """
        self.attributes['LinuxServerShell.HDD Load'] = value
    ...
    def user(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.User'] if 'LinuxServerShell.User' in self.attributes else None
    ...
    def user(self, value):
        ...
        :type value: str
        """
        self.attributes['LinuxServerShell.User'] = value
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['LinuxServerShell.Password'] if 'LinuxServerShell.Password' in self.attributes else None
    ...
    def password(self, value):
        ...
        :type value: string
        """
        self.attributes['LinuxServerShell.Password'] = value
    ...
    def enable_password(self):
        ...
        :rtype: string
        """
        return self.attributes['LinuxServerShell.Enable Password'] if 'LinuxServerShell.Enable Password' in self.attributes else None
    ...
    def enable_password(self, value):
        ...
        :type value: string
        """
        self.attributes['LinuxServerShell.Enable Password'] = value
    ...
    def power_management(self):
        ...
        :rtype: bool
        """
        return self.attributes['LinuxServerShell.Power Management'] if 'LinuxServerShell.Power Management' in self.attributes else None
    ...
    def power_management(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['LinuxServerShell.Power Management'] = value
    ...
    def sessions_concurrency_limit(self):
        ...
        :rtype: float
        """
        return self.attributes['LinuxServerShell.Sessions Concurrency Limit'] if 'LinuxServerShell.Sessions Concurrency Limit' in self.attributes else None
    ...
    def sessions_concurrency_limit(self, value='1'):
        ...
        :type value: float
        """
        self.attributes['LinuxServerShell.Sessions Concurrency Limit'] = value
    ...
    def snmp_read_community(self):
        ...
        :rtype: string
        """
        return self.attributes['LinuxServerShell.SNMP Read Community'] if 'LinuxServerShell.SNMP Read Community' in self.attributes else None
    ...
    def snmp_read_community(self, value):
        ...
        :type value: string
        """
        self.attributes['LinuxServerShell.SNMP Read Community'] = value
    ...
    def snmp_write_community(self):
        ...
        :rtype: string
        """
        return self.attributes['LinuxServerShell.SNMP Write Community'] if 'LinuxServerShell.SNMP Write Community' in self.attributes else None
    ...
    def snmp_write_community(self, value):
        ...
        :type value: string
        """
        self.attributes['LinuxServerShell.SNMP Write Community'] = value
    ...
    def snmp_v3_user(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.SNMP V3 User'] if 'LinuxServerShell.SNMP V3 User' in self.attributes else None
    ...
    def snmp_v3_user(self, value):
        ...
        :type value: str
        """
        self.attributes['LinuxServerShell.SNMP V3 User'] = value
    ...
    def snmp_v3_password(self):
        ...
        :rtype: string
        """
        return self.attributes['LinuxServerShell.SNMP V3 Password'] if 'LinuxServerShell.SNMP V3 Password' in self.attributes else None
    ...
    def snmp_v3_password(self, value):
        ...
        :type value: string
        """
        self.attributes['LinuxServerShell.SNMP V3 Password'] = value
    ...
    def snmp_v3_private_key(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.SNMP V3 Private Key'] if 'LinuxServerShell.SNMP V3 Private Key' in self.attributes else None
    ...
    def snmp_v3_private_key(self, value):
        ...
        :type value: str
        """
        self.attributes['LinuxServerShell.SNMP V3 Private Key'] = value
    ...
    def snmp_version(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.SNMP Version'] if 'LinuxServerShell.SNMP Version' in self.attributes else None
    ...
    def snmp_version(self, value=''):
        ...
        :type value: str
        """
        self.attributes['LinuxServerShell.SNMP Version'] = value
    ...
    def enable_snmp(self):
        ...
        :rtype: bool
        """
        return self.attributes['LinuxServerShell.Enable SNMP'] if 'LinuxServerShell.Enable SNMP' in self.attributes else None
    ...
    def enable_snmp(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['LinuxServerShell.Enable SNMP'] = value
    ...
    def disable_snmp(self):
        ...
        :rtype: bool
        """
        return self.attributes['LinuxServerShell.Disable SNMP'] if 'LinuxServerShell.Disable SNMP' in self.attributes else None
    ...
    def disable_snmp(self, value=False):
        ...
        :type value: bool
        """
        self.attributes['LinuxServerShell.Disable SNMP'] = value
    ...
    def console_server_ip_address(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.Console Server IP Address'] if 'LinuxServerShell.Console Server IP Address' in self.attributes else None
    ...
    def console_server_ip_address(self, value):
        ...
        :type value: str
        """
        self.attributes['LinuxServerShell.Console Server IP Address'] = value
    ...
    def console_user(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.Console User'] if 'LinuxServerShell.Console User' in self.attributes else None
    ...
    def console_user(self, value):
        ...
        :type value: str
        """
        self.attributes['LinuxServerShell.Console User'] = value
    ...
    def console_port(self):
        ...
        :rtype: float
        """
        return self.attributes['LinuxServerShell.Console Port'] if 'LinuxServerShell.Console Port' in self.attributes else None
    ...
    def console_port(self, value):
        ...
        :type value: float
        """
        self.attributes['LinuxServerShell.Console Port'] = value
    ...
    def console_password(self):
        ...
        :rtype: string
        """
        return self.attributes['LinuxServerShell.Console Password'] if 'LinuxServerShell.Console Password' in self.attributes else None
    ...
    def console_password(self, value):
        ...
        :type value: string
        """
        self.attributes['LinuxServerShell.Console Password'] = value
    ...
    def cli_connection_type(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.CLI Connection Type'] if 'LinuxServerShell.CLI Connection Type' in self.attributes else None
    ...
    def cli_connection_type(self, value='Auto'):
        ...
        :type value: str
        """
        self.attributes['LinuxServerShell.CLI Connection Type'] = value
    ...
    def cli_tcp_port(self):
        ...
        :rtype: float
        """
        return self.attributes['LinuxServerShell.CLI TCP Port'] if 'LinuxServerShell.CLI TCP Port' in self.attributes else None
    ...
    def cli_tcp_port(self, value):
        ...
        :type value: float
        """
        self.attributes['LinuxServerShell.CLI TCP Port'] = value
    ...
    def backup_location(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.Backup Location'] if 'LinuxServerShell.Backup Location' in self.attributes else None
    ...
    def backup_location(self, value):
        ...
        :type value: str
        """
        self.attributes['LinuxServerShell.Backup Location'] = value
    ...
    def backup_type(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.Backup Type'] if 'LinuxServerShell.Backup Type' in self.attributes else None
    ...
    def backup_type(self, value='File System'):
        ...
        :type value: str
        """
        self.attributes['LinuxServerShell.Backup Type'] = value
    ...
    def backup_user(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.Backup User'] if 'LinuxServerShell.Backup User' in self.attributes else None
    ...
    def backup_user(self, value):
        ...
        :type value: str
        """
        self.attributes['LinuxServerShell.Backup User'] = value
    ...
    def backup_password(self):
        ...
        :rtype: string
        """
        return self.attributes['LinuxServerShell.Backup Password'] if 'LinuxServerShell.Backup Password' in self.attributes else None
    ...
    def backup_password(self, value):
        ...
        :type value: string
        """
        self.attributes['LinuxServerShell.Backup Password'] = value
...
class ResourcePort(object):
    ...
    def mac_address(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.ResourcePort.MAC Address'] if 'LinuxServerShell.ResourcePort.MAC Address' in self.attributes else None
    ...
    def ipv4_address(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.ResourcePort.IPv4 Address'] if 'LinuxServerShell.ResourcePort.IPv4 Address' in self.attributes else None
    ...
    def ipv6_address(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.ResourcePort.IPv6 Address'] if 'LinuxServerShell.ResourcePort.IPv6 Address' in self.attributes else None
    ...
    def port_speed(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.ResourcePort.Port Speed'] if 'LinuxServerShell.ResourcePort.Port Speed' in self.attributes else None
...
class GenericPowerPort(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'LinuxServerShell.GenericPowerPort'
        self._name = name
    ...
    def model(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.GenericPowerPort.Model'] if 'LinuxServerShell.GenericPowerPort.Model' in self.attributes else None
    ...
    def model(self, value):
        ...
        :type value: str
        """
        self.attributes['LinuxServerShell.GenericPowerPort.Model'] = value
    ...
    def serial_number(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.GenericPowerPort.Serial Number'] if 'LinuxServerShell.GenericPowerPort.Serial Number' in self.attributes else None
    ...
    def serial_number(self, value):
        ...
        :type value: str
        """
        self.attributes['LinuxServerShell.GenericPowerPort.Serial Number'] = value
    ...
    def version(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.GenericPowerPort.Version'] if 'LinuxServerShell.GenericPowerPort.Version' in self.attributes else None
    ...
    def version(self, value):
        ...
        :type value: str
        """
        self.attributes['LinuxServerShell.GenericPowerPort.Version'] = value
    ...
    def port_description(self):
        ...
        :rtype: str
        """
        return self.attributes['LinuxServerShell.GenericPowerPort.Port Description'] if 'LinuxServerShell.GenericPowerPort.Port Description' in self.attributes else None
    ...
    def port_description(self, value):
        ...
        :type value: str
        """
        self.attributes['LinuxServerShell.GenericPowerPort.Port Description'] = value
